...
<%-- <form style="display:none;" class="" action="toexcel.excel" method="post" id="excelForm">
  <input type="text" name="starter" value="">
    <input type="text" name="ender" value="">
      <input type="text" name="waypoint" value="">
        <input type="text" name="waypoint" value="">
          <input type="text" name="waypoint" value="">
            <input type="text" name="waypoint" value="">
              <input type="text" name="waypoint" value="">
                <input type="text" name="waypoint" value="">
                  <input type="text" name="waypoint" value="">
                    <input type="text" name="waypoint" value="">
                      <input type="text" name="waypoint" value="">
                        <input type="text" name="waypoint" value="">
  <input type="text" name="starter2" value="">
    <input type="text" name="ender2" value="">
      <input type="text" name="waypoint2" value="">
        <input type="text" name="waypoint2" value="">
          <input type="text" name="waypoint2" value="">
            <input type="text" name="waypoint2" value="">
              <input type="text" name="waypoint2" value="">
                <input type="text" name="waypoint2" value="">
                  <input type="text" name="waypoint2" value="">
                    <input type="text" name="waypoint2" value="">
                      <input type="text" name="waypoint2" value="">
                        <input type="text" name="waypoint2" value="">
  <input type="text" name="distance0" value="">
      <input type="text" name="duration0" value="">
</form> --%>
